...
output_dir = 'D:/HCGCN/dataset/training data/'
if not os.path.exists(output_dir):
    os.makedirs(output_dir)

save_adjacency_matrix(herb_pairs, os.path.join(output_dir, 'HCGCN-all herb pairs.cites'))

print(f"Adjacency matrix saved to {os.path.join(output_dir, 'HCGCN-all herb pairs.cites')}")
